...
/// Ecran de profil specifique pour le role medecin chef.
/// Adopte la meme structure encadrante que les profils administrateur,
/// encadreur et chef.
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScrollView(
      ...
      slivers: [
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    l10n.chiefMedicalOfficer.toUpperCase(),
                    style: GoogleFonts.montserrat(
                      fontSize: 11,
                      fontWeight: FontWeight.w700,
        ...
        SliverToBoxAdapter(
          child: _buildSettingsSection(context, colorScheme, isDark, l10n),
        ),
        const SliverToBoxAdapter(child: SizedBox(height: 20)),
        SliverToBoxAdapter(
          child: Padding(
